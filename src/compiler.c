...
{
    // TODO: error here if index greater than MAX_INT in 3 bytes
...
static void defineVariable(int global)
{
    ...
    if (global < 256) {
        ...
        emitBytes(OP_DEFINE_GLOBAL_LONG, global);
    }
}
...
{
    // TODO: add common escape sequences
...
static void expression() { parsePrecedence(PREC_ASSIGMENT); }
